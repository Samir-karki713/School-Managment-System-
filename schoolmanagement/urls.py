...
from school.views import custom_logout_view
...
urlpatterns = [
    ...
    path('student/waiting-approval/', views.student_waiting_approval_view, name='student-waiting-approval'),
    path('teacher/waiting-approval/', views.teacher_waiting_approval_view, name='teacher-waiting-approval'),
